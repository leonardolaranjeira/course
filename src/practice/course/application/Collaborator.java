...
public class Collaborator {
    public static void main(String[] args) {
        ...
        List<practice.course.entities.Collaborator> employeeList = new ArrayList<>();
        ...
        for (int i = 0; i < qtt; i++) {
            ...
            do {
                ...
                for (practice.course.entities.Collaborator existingEmployee : employeeList) {
            ...
            practice.course.entities.Collaborator employee = new practice.course.entities.Collaborator(id, name, salary);
        ...
        do {
            ...
            for (practice.course.entities.Collaborator employee : employeeList) {
