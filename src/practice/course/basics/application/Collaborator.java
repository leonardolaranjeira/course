...
public class Collaborator {
    public static void main(String[] args) {
        ...
        List<practice.course.basics.entities.Collaborator> employeeList = new ArrayList<>();
        ...
        for (int i = 0; i < qtt; i++) {
            ...
            do {
                ...
                for (practice.course.basics.entities.Collaborator existingEmployee : employeeList) {
            ...
            practice.course.basics.entities.Collaborator employee = new practice.course.basics.entities.Collaborator(id, name, salary);
        ...
        do {
            ...
            for (practice.course.basics.entities.Collaborator employee : employeeList) {
