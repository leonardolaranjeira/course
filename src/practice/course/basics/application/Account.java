    ...
    static void main() {
        ...
        while (true) {
            ...
            if (sc.hasNextInt()) { //Lê o que será digitado pelo usuário direto da condição if
                ...
                if (accountNumber >= practice.course.basics.entities.Account.MIN_ACCOUNT_NUMBER && accountNumber <= practice.course.basics.entities.Account.MAX_ACCOUNT_NUMBER) {
        ...
        practice.course.basics.entities.Account account; //Objeto da classe conta
        account = new practice.course.basics.entities.Account(accountNumber, name);
